...
response=$(curl -s --location 'https://vl890982-pwlessgtopoc.sspdev.dev.broadcom.com/default/oauth2/v1/token' \
...
response=$(curl -s --location 'https://vl890982-pwlessgtopoc.sspdev.dev.broadcom.com/default/pwlessauthn/v1/client/auth/api/v3/do-authenticationV4' \
